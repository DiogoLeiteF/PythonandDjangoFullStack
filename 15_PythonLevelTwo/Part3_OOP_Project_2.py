...
while user.still_has_cards() and comp.still_has_cards():
    ...
    if c_card[1] == p_card[1]:
        ...
        if user.still_has_cards() and comp.still_has_cards():
            ...
            if RANKS.index(c_card[1]) < RANKS.index(p_card[1]):
            ...
            elif RANKS.index(c_card[1]) > RANKS.index(p_card[1]):
                ...
                if user.still_has_cards() and comp.still_has_cards():
                    ...
                    if RANKS.index(c_card[1]) < RANKS.index(p_card[1]):
                        ...
                        user.hand.add(table_cards[:(len(table_cards)/2)])
                        comp.hand.add(table_cards[(len(table_cards)/2):])
                else:
                    break
...
print(f"a Double war happened {double_war} times")
...
# Use the 3 classes along with some logic to play a gam
# e of war!
